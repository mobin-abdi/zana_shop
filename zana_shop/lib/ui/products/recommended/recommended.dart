...
import 'package:zana_shop/ui/products/recommended/recommended_bloc/recommended_bloc.dart';
            ...
            builder: (context, state) {
              if (state is RecommendedLoading) {
                ...
                if (state.recommendedProducts.isEmpty) {
                  return EmptyState(
                    message: "there are no recommended products",
                  );
                }

                return RefreshIndicator(
                  onRefresh: () async =>
                      context.read<RecommendedBloc>()
                        ..add(RecommendedSrarted()),
                  child: Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final products = state.recommendedProducts[index];
                        return InkWell(
                          onTap: () {
